...
export default function OrderDetailPage({ params }: { params: { id: string } }) {
  ...
  async function patch(body: Partial<Order>) {
  ...
  async function confirmPayment() {
    ...
    if (ok) { setNewStatus("payment_received"); showToast("Payment confirmed"); }
  }
  ...
  if (!order) return (
    <div className="flex flex-col flex-1 items-center justify-center gap-3">
      <p className="font-inter-tight text-[#888078]">Order not found</p>
      <Link href="/admin/orders" className="font-inter-tight text-[13px] text-[#c9a96e] hover:underline">← Back to orders</Link>
    </div>
  );
  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <AdminTopbar
        ...
        actions={
          <Link href="/admin/orders" className="font-inter-tight text-[13px] text-[#888078] hover:text-[#e8e4df] transition-colors">
            ← Back
          </Link>
        }
      />
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-4 sm:gap-6 px-4 sm:px-8 py-4 sm:py-6 overflow-y-auto">
        ...
        <div className="flex-1 space-y-4 sm:space-y-6 min-w-0">
          ...
          <div className="bg-[#16181d] rounded-[12px] border border-[rgba(255,255,255,0.07)] overflow-hidden">
            ...
            <div className="px-5 py-4 border-t border-[rgba(255,255,255,0.07)] flex justify-end">
              <p className="font-inter-tight text-[14px] text-[#e8e4df]">
        ...
        {/* Right sidebar — full width on mobile, fixed 288px on desktop */}
        <div className="w-full lg:w-72 space-y-4 shrink-0">
          ...
          <div className="bg-[#16181d] rounded-[12px] border border-[rgba(255,255,255,0.07)] p-5 space-y-3">
            ...
            {order.customer_phone && (
              <a
                href={`https://wa.me/${order.customer_phone.replace(/\D/g, "")}?text=${encodeURIComponent(`Hi ${order.customer_name}, regarding your MoLuxury order ${order.order_ref}`)}`}
