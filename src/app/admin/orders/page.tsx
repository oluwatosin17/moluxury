          ...
          <table className="w-full">
            ...
            <tbody>
              {loading ? (
                ...
                <tr>
                  <td colSpan={7} className="py-16 text-center font-inter-tight text-[13px] text-[#888078]">
                ...
                <tr key={o.id} className="border-b border-[rgba(255,255,255,0.04)] hover:bg-[rgba(255,255,255,0.01)] transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <Link href={`/admin/orders/${o.id}`} className="font-inter-tight text-[12px] text-[#888078] hover:text-[#c9a96e] transition-colors">
                      View →
                    </Link>
                  </td>
                </tr>
